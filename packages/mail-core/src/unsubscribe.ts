...
// The HOST comes from the request/page origin — a single worker can serve many
// domains, so the host must NOT be baked into config/env. An optional configured
// value overrides only the path/query: a relative value (default "/unsubscribe")
