...
// This site doesn't use Astro's ClientRouter, so `astro:page-load` never
// fires. The module script is deferred, so the DOM is ready by the time it
// runs — call setup directly. (Per the mermaid recipe's ClientRouter note.)
setup();
