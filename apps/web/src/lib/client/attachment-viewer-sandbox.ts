...
// Without allow-same-origin the framed doc gets an opaque origin, with no access
// to the app's cookies, DOM, or storage. This viewer renders attacker-controlled
...
// Deliberately weaker isolation than the opaque viewer: the compensating
