...
<Sonner
	theme={mode.current}
	class="toaster group"
	style="--normal-bg: var(--color-popover); --normal-text: var(--color-popover-foreground); --normal-border: var(--color-border); --border-radius: var(--radius-xl); --success-bg: color-mix(in oklch, var(--ok) 10%, var(--popover)); --success-text: var(--ok); --success-border: color-mix(in oklch, var(--ok) 32%, var(--popover)); --error-bg: color-mix(in oklch, var(--destructive) 10%, var(--popover)); --error-text: var(--destructive); --error-border: color-mix(in oklch, var(--destructive) 32%, var(--popover)); --warning-bg: color-mix(in oklch, var(--warn) 10%, var(--popover)); --warning-text: var(--warn); --warning-border: color-mix(in oklch, var(--warn) 32%, var(--popover)); --info-bg: color-mix(in oklch, var(--brand) 10%, var(--popover)); --info-text: var(--brand); --info-border: color-mix(in oklch, var(--brand) 32%, var(--popover));"
	toastOptions={{
		classes: {
