	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				success: "bg-ok/10 [a]:hover:bg-ok/20 text-ok dark:bg-ok/20",
				warning: "bg-warn/10 [a]:hover:bg-warn/20 text-warn dark:bg-warn/20",
				info: "bg-brand/10 [a]:hover:bg-brand/20 text-brand dark:bg-brand/20",
