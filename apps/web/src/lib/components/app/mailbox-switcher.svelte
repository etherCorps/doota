<script lang="ts">
	...
	const kindOf = (b: Box | undefined): Kind =>
		b?.isService ? 'service' : (b?.isPersonal ?? true) ? 'personal' : 'shared';
	...
	const tileClass: Record<Kind, string> = {
		...
		shared:
			'bg-emerald-500/10 text-emerald-600 ring-emerald-500/20 dark:bg-emerald-400/10 dark:text-emerald-400 dark:ring-emerald-400/25',
		service:
	...
	>
		...
		>
			...
			{:else if kind === 'shared'}
				...
				<path d="M4 12.5 6 6.5A2 2 0 0 1 7.9 5h8.2a2 2 0 0 1 1.9 1.5l2 6V17a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Z" />
